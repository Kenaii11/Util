...
local function getDragIt()
    ...
    if IsClient then
        ...
        local TWS = GetService.TweenService
...
local CircleClick = function(Button)
    ...
    local tween = GetService.TweenService:Create(circle, TweenInfo.new(.4, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), finalGoal);
    tween:Play();
end
...
function UILibrary.new(gameName, userId, rank)
    ...
    GUI.Parent =
        RunService:IsStudio() == false and HUI or GetService.CoreGui or LocalPlayer:WaitForChild("PlayerGui")
    ...
    functions.openMenu = function()
        ...
        table.insert(
            ...
            RunService.RenderStepped:Connect(
                function()
                    local mousePos =
                    GetService.UserInputService:GetMouseLocation() -
                        Vector2.new(0, GetService.GuiService:GetGuiInset().Y)
